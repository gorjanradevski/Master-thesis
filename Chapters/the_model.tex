...
By lowercasing and removing the punctuation, it is assured that the words tokens are consistent throughout the dataset. Therefore, a word token remains the same independently of the position of the word in the sentence.
