...
Because of the increased size of the \textit{Flickr8k} dataset compared to the \textit{Pascal1k} dataset, methods that rely on deep learning \cite{ma2015multimodal, kiros2014unifying, karpathy2015deep, mao2014explain, klein2015associating}, are starting to significantly outperforms simple methods \cite{socher2014grounded, frome2013devise, karpathy2014deep}. This can be seen on table \ref{flickr8kkresults}. Also, due to the increased size of the dataset, \textit{SMHA} is taking over the first place from \textit{FV}. However, this dataset can still be considered as small compared to the capacity of data the deep learning models can consume and yet again, a simple method may yield competitive results.
